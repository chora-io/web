...
const Policies = () => {
  ...
  useEffect(() => {
    ...
    if (policies && sort === "ascending") {
      ps.sort((a: any, b: any) => new Date(b["created_at"]).getUTCDate() - new Date(a["created_at"]).getUTCDate())
    }

    if (policies && sort === "descending") {
      ps.sort((a: any, b: any) => new Date(a["created_at"]).getUTCDate() - new Date(b["created_at"]).getUTCDate())
    }
